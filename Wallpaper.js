...
class Wallpaper extends Component {
    ...
    onOptionsChange(event) {
        ...
        axios.get(`http://localhost:6355/getRestaurantByLocation/${cityName}`)
            .then(result => {
                this.setState({
    ...
    render() {
        ...
        return (
            <>
                <img src={require('../Assets/breakfast.jpg').default} className="homeImage" alt="homeimage" width="100px" height="50px" />
