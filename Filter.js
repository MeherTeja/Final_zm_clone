...
class Filter extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:6355/getLocations')
            .then(result => {
    ...
    filterRestaurants() {
        ...
        axios({
            method: 'POST',
            url: 'http://localhost:6355/filterRestaurants',
                                    ...
                                    restaurantList.map((item, index) => {
                                        return <div key={index} className="row resultBox" onClick={() => this.goToDetails(item)}>
                                                    <div className="topSection row">
                                                        <div className="col-3">
                                                            <img className="resultImage" src={require('../Assets/breakfast.jpg').default} alt="myimage" />
                                                        </div>
                                                        <div className="col-9">
